...
## Krystel Notes:
1. In Pop OS, runs with LuaLaTeX.
2. Install the following packages first: cite, xcolor, ms, substr, isodate, titlesec, fontspec, textpos via:
    tlmgr install <packagename>
3. Publication not working
