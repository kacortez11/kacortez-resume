...
\documentclass[top=0.5in]{deedy-resume-openfont}
\usepackage{fancyhdr}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Krystel Arriane}{Cortez}{
\href{mailto:krystelarrianecortez@gmail.com}{krystelarrianecortez@gmail.com} | +63.917.831.2627 \\% \href{mailto:kacortez2@up.edu.ph}{kacortez2@up.edu.ph}
\urlstyle{same}\href{http://www.linkedin.com/in/kacortez}{linkedin.com/in/kacortez} | Quezon City, Philippines %\href{http://fb.co/dd}{fb.co/dd}\\
}
...
%    Coursera
%
%    \item Six Sigma Yellow Belt\\
%    \urlstyle{same}\href{http://www.coursera.org/verify/specialization/X3WCGV4LH9QP}{Coursera ID#X3WCGV4LH9QP}
%\end{tightemize}
\sectionsep
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\location{May – June 2014 | Quezon City, Philippines}
...
%% v2"
%\\Cortez, K. A. \& Magno, K. J. (2015). \textit{Identification of Philippine Algae Species from Images using Naive Bayes Classifier.}
%Paper presented at the Proceedings of the 15th Philippine Computing Science Congress: 92--99
